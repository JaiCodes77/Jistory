...
export function AskSessionSidebar({
  ...
  return (
    <aside className="flex h-full min-h-0 w-56 shrink-0 flex-col border-r border-border bg-sidebar max-md:h-auto max-md:max-h-32 max-md:w-full max-md:border-r-0 max-md:border-b">
            ...
            {sessions.map((session) => {
              ...
              return (
                <li key={session.id}>
                  <div
                    className={cn(
                      "flex items-start gap-1 rounded-md px-2 py-1.5 max-md:w-44",
